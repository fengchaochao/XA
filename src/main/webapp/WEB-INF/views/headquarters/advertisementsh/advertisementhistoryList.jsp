...
<body class="mainContant">
    ...
    <div class="pageHeadline">
       <span class="leftNotice">广告历史记录</span>
    </div>
    <!--end pageHeadline -->
	...
	<div class="whiteBox">
	    ...
	    <form id="formSearch" class="form-horizontal">
			<div class="form-group" style="margin-top: 15px;margin-left: -31px;">
			    <label class="control-label col-sm-2" style="width:80px;">状态</label>
				<div id="queryDiv" class="col-sm-3" style="text-align: left;padding-left: 0px;">
					<select id="checkState" class="form-control" onchange="findByStauts()">
	...
	<script type="text/javascript">
		...
		function initTable() {
            $table = $('#tb_board').bootstrapTable({
                method: 'get',
                url : '<spring:url value="/headquarters/advertsh/doReadAdvertisingHistoryList" />',
                pagination: true,
                pageSize: 10,
