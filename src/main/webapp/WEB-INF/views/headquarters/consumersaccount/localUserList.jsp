...
<body class="mainContant">
    ...
    <div class="pageHeadline">
       <span class="leftNotice">锁定的用户详情</span>
    </div>
    <!--end pageHeadline -->
	...
	<script type="text/javascript">
		...
		function initTable() {
            $table = $('#tb_board').bootstrapTable({
                method: 'get',
                url : '<spring:url value="/headquarters/consumersAccount/doReadLocalUserList" />?businessInformationId='+$("#businessInformationId").val(),
                pagination: true,
                pageSize: 10,
                ...
                columns : [ {
					...
					field : 'consumers.customerNumber',
					title : '消费商编号'
				}, {
		...
		// 编辑操作
        function editRecord() {
			window.location.href='<spring:url value="/headquarters/consumers/doEnConsumersEdit"/>'+'?consumersId='+$("#businessInformationId").val();
        }
	</script>
