...
<body class="mainContant">
   ...
   <div class="pageHeadline">
      <span class="leftNotice">代理商管理</span>
      <span class="greenBtn" id="btn_add">新增代理商</span>
   </div>
   <!--end pageHeadline -->
   ...
   <div class="whiteBox">
	...
	<script type="text/javascript">
        ...
        function operateFormatter(value, row, index) {
        	...
        	if(state=="0"){
           		 var e = '<a class="blueText" href="#" mce_href="#" onclick="editRecord(\''+ index + '\')">查看</a> <a class="redText" href="#" mce_href="#" onclick="delRecord(\''+ index + '\')">停用</a>';  
        	}
        	if(state=="1"){
           		 var e = '<a class="blueText" href="#" mce_href="#" onclick="editRecord(\''+ index + '\')">查看</a> <a class="greenText" href="#" mce_href="#" onclick="delRecord(\''+ index + '\')">启用</a>';  
        	}
            return e;  
        }
