...
<head>
    ...
    <style>
   .informateBox .leftBox,.informateBox .rightBox{height:850px;} 
    </style>
</head>
<script>
	/*
		...
		'onUploadSuccess' : function(file, data, response){
        	...
        	if(jsonData.body.upfileFilePath!=null && jsonData.body.upfileFilePath!=''){
        		...
        		$("#storePhotos").val(upfilepath);
       			...
       			var b='<spring:url value="/'+upfilepath+'" />';
       			var a='<div style="display:inline-block;margin:5px;"><span class="imgDelet2" id="'+upfilepath+'" style="display:block;cursor: pointer;color:##337ab7;">删除</span><img alt="" src="'+b+'" class="pics" style="width: 130px;height: 90px"/></div>'
       			$("#material2").html(a);
				...
				$.ajax({
					...
					success: function(data){
						if(data.body=="保存成功"){
							...
							top.layer.alert(data.body, {icon: 6});
							return;
						}
					}
				});
