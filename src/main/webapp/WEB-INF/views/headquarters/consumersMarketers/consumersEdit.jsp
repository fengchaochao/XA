...
<body class="mainContant">
	...
	<input type="hidden" id="agentId" value="${consumers.agentId}" />
	...
	$(function() {
	   	$("#return").bind("click",function(){
	   		if($("#flag").val()=='1'){
				window.location.href='<spring:url value="/headquarters/consumersMarketers/doEnConsumersMarketersList" />';
		   	}
	   	 	if($("#flag").val()=='2'){
				window.location.href='<spring:url value="/headquarters/agent/doEnAgentEdit"/>'+'?agentId='+$("#agentId").val();
			}
	   	 	if($("#flag").val()=='3'){
				window.location.href='<spring:url value="/headquarters/memberStatistics/doEnAgentEdit"/>'+'?agentId='+$("#agentId").val();
			}
			if($("#flag").val()=='4'){
