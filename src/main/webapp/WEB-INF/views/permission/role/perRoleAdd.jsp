...
<body style="background:#fff;padding-top:30px;">
	...
	<div class="form-group">
		...
		<div class="col-sm-10"> 
			<input type="text" class="form-control" id="roleIntroduce" placeholder="角色介绍" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="navbar-btn">
		...
		<button type="button" class="referBtn col-sm-offset-1" id="submit">提交</button>
	</div>
	</form>
	...
	$(function() {
		...
		$("#submit").bind("click",function(){
			$.ajax({
				type: "POST",
				url: '<spring:url value="/role/doAddRole" />', 
				data:{
