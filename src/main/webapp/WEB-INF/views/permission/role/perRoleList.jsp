...
<body class="mainContant">
    ...
    <div class="pageHeadline">
       <span class="leftNotice">角色管理</span>
    </div>
    <!--end pageHeadline -->
	...
	<div class="whiteBox">
		...
		<p style="text-align:right;"><span id="btn_add" class="referBtn">添加</span></p>
	...
	<script type="text/javascript">
      ...
      //被子页面调用
		...
		function operateFormatter(value, row, index) {
			var e = '<a href="#" class="blueText" mce_href="#" onclick="editRecord(\'' + index	+ '\')">编辑</a> ';
			return e;
		}
