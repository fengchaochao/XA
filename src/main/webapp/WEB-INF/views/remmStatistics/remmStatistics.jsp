...
<body class="mainContant">
   ...
   <div class="pageHeadline">
      <span class="leftNotice">推荐统计</span>
   </div>
   <!--end pageHeadline -->
	...
	<script type="text/javascript">
		...
		function initTable() {
            $table = $('#tb_board').bootstrapTable({
                method: 'get',
                url : '<spring:url value="/headquarters/remmStatistics/doReadRemmStatisticsList" />',
                pagination: false,
                ...
                columns : [ {
					...
					field : 'businessClassification.categoryName',
					title : '商家分类'
				},{
					field : 'orderNum',
					title : '订单数量',
					...
					footerFormatter: function (value) {
					   var count = 0;
					   for (var i in value)  {
					  	 count += Number(value[i].remmBonusNum); 
					   } 
					   return count; 
					}
				}],
		...
		function initTable1() {
            $table1 = $('#tb_board1').bootstrapTable({
                method: 'get',
                url : '<spring:url value="/headquarters/remmStatistics/doReadRemmOrderList" />',
                pagination: true,
                pageSize: 10,
