...
<body class="mainContant">
    ...
    <div class="pageHeadline">
       <span class="leftNotice">我的广告</span>
       <p>
           <button type="button" id="btn_add" class="greenBtn">添加</button>
       </p>
    </div>
    <!--end pageHeadline -->
	...
	<script type="text/javascript">
        ...
        function updRecord(index){
       		var row = $table.bootstrapTable('getData')[index];
        	window.location.href='<spring:url value="/business/advertising/doEnAdvertisingEdit" />'+'?advertisingId='+row.id;
        }
        ...
        function operateFormatter(value, row, index) {
        	...
        	var e = "";
        	if(checkState == "3"){
        		e = '<a href="#" class="orangeText" mce_href="#" onclick="editRecord(\''+ index + '\')">发布</a>';
        	}else if(checkState == "2"){
        		e = '<a href="#" class="blueText" mce_href="#" onclick="updRecord(\''+ index + '\')">编辑</a>';
        	}
            return e;  
        }
