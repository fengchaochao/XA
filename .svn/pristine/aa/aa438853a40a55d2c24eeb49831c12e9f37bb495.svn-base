...
<head>
    ...
    <style>
		...
		.showBox{border:1px solid #666;position:fixed;z-index:100000;background:#fff;padding:10px;top:15%;left:25%;width: 400px;
...
<body class="mainContant">
	...
	<div class="pageHeadline">
	   <span class="leftNotice">推荐商家列表</span>
	</div>
	<!--end pageHeadline -->
	...
	<div class="whiteBox">
	    <form id="formSearch" class="form-horizontal">
			<div class="form-group" style="margin-top: 15px;">
				<label class="control-label" for="businessState" style="float: left;">状态</label>
				<div class="col-sm-2">
				...
				<div class="col-sm-2" style="width:230px;margin-right:2%;">
					<input type="text" class="form-control" id="keySeach" placeholder="请输入商家名称或商家编号"/>
				</div>
	...
	<script type="text/javascript">
		...
		function initTable() {
            $table = $('#tb_board').bootstrapTable({
                method: 'get',
                url : '<spring:url value="/headquarters/recommendBusinessInformation/doReadAgentShowBusinessInformationList" />',
                pagination: true,
                pageSize: 10,
        ...
        function editRecord(index) {
        	var row=$table.bootstrapTable('getData')[index];
			window.location.href='<spring:url value="/headquarters/recommendBusinessInformation/doEnBusinessInformationEdit"/>'+'?businessInformationId='+row.id;
        }
        ...
        function operateFormatter(value, row, index) {
         	var e = '<button type="button" class="btn btn-primary" onclick="editRecord(\''+ index + '\')" >新建商家</button>';  
            return e;  
        }
		// 查询参数设置  
