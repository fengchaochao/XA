...
<body class="mainContant">
	...
	<div class="pageHeadline">
		<span class="leftNotice">消费商管理</span>
	</div>
	<!--end pageHeadline -->
    ...
    <form id="formSearch" class="form-horizontal">
		<div class="form-group" style="margin-top: 15px;">
			...
			<div class="chooseTimeCom" style="margin-left:2%;">
	...
	<script type="text/javascript">
		...
		function initTable() {
            $table = $('#tb_board').bootstrapTable({
                method: 'get',
                url : '<spring:url value="/headquarters/consumersMarketers/doReadConsumersMarketersList" />',
                pagination: true,
                pageSize: 10,
        ...
        function editRecord(index) {
			...
			window.location.href='<spring:url value="/headquarters/consumersMarketers/doEnConsumersEdit"/>'+'?consumersId='+row.id+'&flag=1';;
        }
					...
					$.ajax({
						...
						success: function(data){
							if("0000000"==data.head.respCode){
								$table.bootstrapTable('refresh', {url: '<spring:url value="/headquarters/consumersMarketers/doReadConsumersMarketersList" />'});
